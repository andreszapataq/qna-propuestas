      ...
      <section className="bg-card shadow-card mb-5 rounded-[10px] border border-border p-6">
        ...
        <div className="mb-5 flex flex-wrap gap-3">
          <button
            ...
            className="shadow-btn-accent inline-flex items-center gap-2 rounded-lg bg-gradient-to-br from-accent to-accent-dark px-7 py-3 text-[14px] font-semibold text-white transition-transform hover:-translate-y-px"
          >
        ...
        <label
          className={`block cursor-pointer rounded-[10px] border-2 border-dashed p-10 text-center transition-colors ${
